...
// Import Phases
import Phase1_Intro from '../components/phases/Phase1_Intro';
import Phase3_Simulation from '../components/phases/Phase3_Simulation';
import Phase4_Report from '../components/phases/Phase4_Report';
